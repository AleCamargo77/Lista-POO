...
Lista de Produtos (CRUD | POO) para treinar habilidades do Html, CSS e principalmente Programação Orientada a objetos em Javascript .
...
Inicialmente utilizado HTML e suas tags semânticas para montagem do corpo da página. No CSS, utilizado recursos para estilização, efeitos animados para garantir uma experiência ao usuário mais eficaz. Além de criar a aplicação de maneira responsiva. E por fim, utilizado Javascript orientadado a objetos, criação de métodos (CRUD), eventos  e manipulação do DOM, . 
  
 
 <p dir="auto">Link para acessar o projeto: <a target="_blank" href="https://alecamargo77.github.io/Lista-POO/"> Lista de Produtos (CRUD | POO) </a></p>
 
 Interface:


 ![Lista Clientes POO](https://user-images.githubusercontent.com/105398640/203586262-29a4d89a-5981-45a2-a377-264077e98fef.gif)
